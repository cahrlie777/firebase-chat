...
function ChatRoom() {
  ...
  return (<>
    ...
    <form onSubmit={sendMessage}>
      ...
      <input value={formValue} onChange={(e) => setFormValue(e.target.value)} placeholder="chat with your friends" />
...
function ChatMessage(props) {
  ...
  return (<>
    <div className={`message ${messageClass}`}>
      <img alt="load image" src={photoURL || 'https://api.adorable.io/avatars/23/abott@adorable.png'} />
      <p>{text}</p>
    </div>
  </>)
}
